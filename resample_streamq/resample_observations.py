...
all_variables_for_sum = ["rain"]
all_variables_for_mean = ["river_flow_rate"]
...
def parse_args():
    ...
    parser.add_argument("--variables", nargs="+", default=["river_flow_rate"],
...
def main():
    ...
    # Adding the reaches
    ds_resampled["rchid"] = ds["station_rchid"]
